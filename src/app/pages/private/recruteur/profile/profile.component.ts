...
export class ProfileRecruteurComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.entrepriseForm = this.formBuilder.group({
      nom : [this.EntrepriseInfo?.nom?this.EntrepriseInfo.nom:'',[
        Validators.required,
      ]],
      domaine : [this.EntrepriseInfo?.domaine?this.EntrepriseInfo.domaine:'',[
        Validators.required,
      ]],
      type : [this.EntrepriseInfo?.type?this.EntrepriseInfo.type:'',[
        Validators.required,
      ]],
      apercu : [this.EntrepriseInfo?.apercu?this.EntrepriseInfo.apercu:'',[
        Validators.required,
      ]],
      slogan : [this.EntrepriseInfo?.slogan?this.EntrepriseInfo.slogan:'',[
        Validators.required,
      ]],
      video : [''],
      pays : [this.EntrepriseInfo?.pays?this.EntrepriseInfo.pays:'',[
        Validators.required,
      ]],
      adresse : [this.EntrepriseInfo?.adresse?this.EntrepriseInfo.adresse:'',[
        Validators.required,
      ]],
      site : [this.EntrepriseInfo?.site?this.EntrepriseInfo.site:'',[
        Validators.required,
      ]],
    })
    this.adminForm = this.formBuilder.group({
      nom : [this.AdminInfo?.nom?this.AdminInfo.nom:'',[
        Validators.required,
      ]],
      prenom : [this.AdminInfo?.prenom?this.AdminInfo.prenom:'',[
        Validators.required,
      ]],
      telephone : [this.AdminInfo?.telephone?this.AdminInfo.telephone:'',[
        Validators.required,
      ]],
      email_contact : [this.AdminInfo?.email_contact?this.AdminInfo.email_contact:'',[
        Validators.email,
        Validators.required
      ]],
      poste : [this.AdminInfo?.poste?this.AdminInfo.poste:'',[
        Validators.required,
      ]],
      linkedin : [this.AdminInfo?.linkedin?this.AdminInfo.linkedin:'',[
        Validators.required,
      ]],
    })
    // parametresForm
    this.parametresForm = this.formBuilder.group({
    })
    // settingsForm
   ...
   // getters entrepriseForm
   get nom_entreprise(){return this.entrepriseForm.controls['nom']}
   get domaine(){return this.entrepriseForm.controls['domaine']}
   get type(){return this.entrepriseForm.controls['type']}
   get apercu(){return this.entrepriseForm.controls['apercu']}
   get slogan(){return this.entrepriseForm.controls['slogan']}
   get video(){return this.entrepriseForm.controls['video']}
   get pays(){return this.entrepriseForm.controls['pays']}
   get adresse(){return this.entrepriseForm.controls['adresse']}
   get site(){return this.entrepriseForm.controls['site']}
   // getters adminForm
   get nom_admin(){return this.adminForm.controls['nom']}
   get prenom(){return this.adminForm.controls['prenom']}
   get telephone(){return this.adminForm.controls['telephone']}
   get poste(){return this.adminForm.controls['poste']}
   get linkedin(){return this.adminForm.controls['linkedin']}
   get email_contact(){return this.adminForm.controls['email_contact']}
  ...
  // photo
  uploadedPhoto !: File
  uploadPhoto(event : any,user_type : string) {
    ...
    .subscribe((result : any) => {
      if(result.success){
        ...
        this.entrepriseForm.patchValue({
          nom: result.entreprise_information.nom,
          domaine: result.entreprise_information.domaine,
          type: result.entreprise_information.type,
          apercu: result.entreprise_information.apercu,
          slogan: result.entreprise_information.slogan,
          pays: result.entreprise_information.pays,
          adresse: result.entreprise_information.adresse,
          site: result.entreprise_information.site
        });
      }
    })
  }
    ...
    .subscribe((result : any) => {
      if(result.success){
        ...
        this.adminForm.patchValue({
          nom: result.admin_information.nom,
          prenom: result.admin_information.prenom,
          telephone: result.admin_information.telephone,
          email_contact: result.admin_information.email_contact,
          poste: result.admin_information.poste,
          linkedin: result.admin_information.linkedin
        });
      }
    })
  }
  // save Entreprise Information
  saveEntrepriseInfo(){
    this.EntrepriseInfo.nom = this.nom_entreprise.value
    this.EntrepriseInfo.domaine = this.domaine.value
    this.EntrepriseInfo.type = this.type.value
    this.EntrepriseInfo.apercu = this.apercu.value
    this.EntrepriseInfo.slogan = this.slogan.value
    this.EntrepriseInfo.pays = this.pays.value
    this.EntrepriseInfo.adresse = this.adresse.value
    this.EntrepriseInfo.site = this.site.value
    this.profileService.saveEntrepriseInfo(this.token.accessToken,this.EntrepriseInfo)
    .subscribe((result : any) => {
      if(result.success){
        this.EntrepriseInfo = result.entreprise_information
        this.showToast("success","Mis à jour avec succès","Données d'entreprise mis à jour avec succès.")
      }else{
        this.showToast("warning","Une erreur s'est produite","Une erreur s'est produite lors de mis à jour des données d'entreprise.")
      }
    })
    // upload Video
    if(this.uploadedVideo){
      ...
      formData.append('user_type','entreprise')
      formData.append('user_id',this.user.id)
      this.profileService.uploadFile(this.token.accessToken,formData)
      .subscribe((result  :any) => {
        this.Video = result.video
  ...
  // save Entreprise Information
  saveAdminInfo(){
    this.AdminInfo.nom = this.nom_admin.value
    this.AdminInfo.prenom = this.prenom.value
    this.AdminInfo.telephone = this.telephone.value
    this.AdminInfo.email_contact = this.email_contact.value
    this.AdminInfo.poste = this.poste.value
    this.AdminInfo.linkedin = this.linkedin.value
    this.profileService.saveAdminInfo(this.token.accessToken,this.AdminInfo)
    .subscribe((result : any) => {
      if(result.success){
        this.AdminInfo = result.admin_information
        this.showToast("success","Mis à jour avec succès","Données de représentant mis à jour avec succès.")
      }else{
        this.showToast("warning","Une erreur s'est produite","Une erreur s'est produite lors de mis à jour des données de représentant.")
      }
    })
  }
  // changePassword
  changePassword(){
    if(this.old_password.value == this.new_password.value){
      this.showToast("warning","Une erreur s'est produite","Le mot de passe actuel et le nouveau mot de passe sont les même !")
    }else{
